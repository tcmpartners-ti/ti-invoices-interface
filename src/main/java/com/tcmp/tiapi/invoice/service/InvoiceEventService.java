...
public class InvoiceEventService {
  ...
  public void saveInvoiceInfoFromCreationMessage(
      String invoiceUuid, CreateInvoiceEventMessage invoiceEventMessage) {
  ...
  public void saveInvoiceEventInfoFromFinanceMessage(
      String invoiceUuid, FinanceBuyerCentricInvoiceEventMessage invoiceEventMessage) {
    String invoiceNumber =
        invoiceEventMessage
            .getInvoiceNumbersContainer()
            .getInvoiceNumbers()
            .get(0)
            .getInvoiceNumber();
  ...
  // Hotfix: find a better and cleaner way of doing this.
  private InvoiceMaster findInvoiceFromFinanceMessage(
      FinanceBuyerCentricInvoiceEventMessage invoiceEventMessage) {
