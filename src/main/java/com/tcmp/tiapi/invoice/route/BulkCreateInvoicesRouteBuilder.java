...
public class BulkCreateInvoicesRouteBuilder extends RouteBuilder {
  ...
  public void configure() {
    ...
    from(uriFrom)
        ...
        .unmarshal()
        .bindy(BindyType.Csv, InvoiceCreationRowCSV.class)
        .transform()
        .body(InvoiceCreationRowCSV.class, this::mapCsvRowToTIMessage)
        .to(uriTo)
        .end();
  }

  private CreateInvoiceEventMessage mapCsvRowToTIMessage(
      InvoiceCreationRowCSV body, Map<String, Object> headers) {
