...
public abstract class ProgramMapper {
  ...
  @Mapping(target = "customer.mnemonic", expression = "java(StringMappingUtils.trimNullable(program.getCustomerMnemonic()))")
  @Mapping(source = "startDate", target = "startDate")
  @Mapping(source = "expiryDate", target = "expiryDate")
  @Mapping(source = "type", target = "type")
  @Mapping(target = "creditLimit", expression = "java(currencyAmountMapper.mapToDto(program.getAvailableLimitAmount(), program.getAvailableLimitCurrencyCode()))")
